...
export default function DeleteBovineAlertDialog( {bovineCode} ) {
    ...
    <React.Fragment>
      ...
      >
        <DialogTitle id="alert-dialog-title">
          {translations.confirmDeleteBovine + bovineCode}
        </DialogTitle>
        <DialogContent>
        ...
        <DialogActions>
          ...
          <Button type='button' onClick={handleCloseAndDelete} autoFocus>
            {translations.delete}
          </Button>
        </DialogActions>
      </Dialog>
